        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" className="bg-gray-800 hover:bg-indigo-600 p-2.5 rounded-lg transition-colors duration-200">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="#" className="bg-gray-800 hover:bg-pink-600 p-2.5 rounded-lg transition-colors duration-200">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="#" className="bg-gray-800 hover:bg-sky-500 p-2.5 rounded-lg transition-colors duration-200">
                <Twitter className="h-5 w-5" />
              </a>
              <a href="#" className="bg-gray-800 hover:bg-red-600 p-2.5 rounded-lg transition-colors duration-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3 p-4 bg-gray-800/50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Dedicated help</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mt-6 pt-6 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-white rounded px-3 py-1.5">
                <span className="text-red-500 font-bold text-sm">Master</span>
              </div>
              <div className="bg-white rounded px-3 py-1.5">
              ...
              <div className="bg-white rounded px-3 py-1.5">
                <span className="text-purple-600 font-bold text-sm">GPay</span>
              </div>
            </div>
          </div>
        </div>
